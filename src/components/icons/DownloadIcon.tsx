...
/**
 * Vendored animated icon — lucide `download`, in the shape of
 ...
 *
 * Consumer: the HUD footer `Export PNG` action. On hover the glyph pushes the arrow down into the tray.
 *
...
export interface DownloadIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
export const DownloadIcon = forwardRef<DownloadIconHandle, DownloadIconProps>(function DownloadIcon(
  ...
  useImperativeHandle(ref, (): DownloadIconHandle => {
