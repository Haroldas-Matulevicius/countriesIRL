...
/**
 * Vendored animated icon — lucide `list`, in the shape of
 ...
 *
 * Consumer: the `countries` rail row. On hover the glyph nudges the rows up and down.
 *
...
export const ListIcon = forwardRef<ListIconHandle, ListIconProps>(function ListIcon(
  ...
  useImperativeHandle(ref, (): ListIconHandle => {
