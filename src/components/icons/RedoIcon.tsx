...
/**
 * Vendored animated icon — lucide `redo-2`, in the shape of
 ...
 *
 * Consumer: the pinned `Redo Color Change` rail row. On hover the glyph slides right, mirroring undo.
 *
...
export interface RedoIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
export const RedoIcon = forwardRef<RedoIconHandle, RedoIconProps>(function RedoIcon(
  ...
  useImperativeHandle(ref, (): RedoIconHandle => {
