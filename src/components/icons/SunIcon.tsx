...
/**
 * Vendored animated icon — lucide `sun`, in the shape of
 ...
 *
 * Consumer: the HUD footer theme toggle, light mode. On hover the glyph turns the rays a notch.
 *
...
export interface SunIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
export const SunIcon = forwardRef<SunIconHandle, SunIconProps>(function SunIcon(
  ...
  useImperativeHandle(ref, (): SunIconHandle => {
