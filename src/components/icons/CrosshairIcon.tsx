...
/**
 * Vendored animated icon — lucide `crosshair`, in the shape of
...
export interface CrosshairIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}

const CROSSHAIR_VARIANTS = {
  normal: { rotate: 0, scale: 1 },
  animate: { rotate: [0, 90, 0], scale: [1, 0.92, 1] },
};

export const CrosshairIcon = forwardRef<CrosshairIconHandle, CrosshairIconProps>(function CrosshairIcon(
  ...
  useImperativeHandle(ref, (): CrosshairIconHandle => {
