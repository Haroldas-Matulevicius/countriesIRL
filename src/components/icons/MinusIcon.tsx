...
/**
 * Vendored animated icon — lucide `minus`, in the shape of
 ...
 *
 * Consumer: NONE - see `CrosshairIcon.tsx` for the recorded reason. The zoom-out
 * control in the floating camera cluster draws its own inline glyph.
 *
 * On hover the glyph contracts inward.
 *
...
export interface MinusIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
export const MinusIcon = forwardRef<MinusIconHandle, MinusIconProps>(function MinusIcon(
  ...
  useImperativeHandle(ref, (): MinusIconHandle => {
