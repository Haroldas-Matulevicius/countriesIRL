...
/**
 * Vendored animated icon — lucide `check`, in the shape of
 ...
 *
 * Consumer: the selected colour tile marker. On hover the glyph pops on confirm.
 *
...
export interface CheckIconProps extends HTMLAttributes<HTMLSpanElement> {
  size?: number;
}
...
export const CheckIcon = forwardRef<CheckIconHandle, CheckIconProps>(function CheckIcon(
  ...
  useImperativeHandle(ref, (): CheckIconHandle => {
