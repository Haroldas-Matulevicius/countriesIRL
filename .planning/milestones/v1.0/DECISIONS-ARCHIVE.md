# v1.0 Decisions Archive — Phase 1

> **In-flight archive.** Phase 1 architectural decisions moved out of the live
> [`STATE.md`](../../STATE.md) on 2026-07-25 so the active file keeps only the current
> working set. These decisions remain **binding** — they were carried forward into Phase 2,
> not superseded, unless a later entry says otherwise.
>
> Live rules that trump anything here: [`../../coding-rules/general.md`](../../coding-rules/general.md).
