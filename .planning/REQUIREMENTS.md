...
- [x] World and North America canvas variants remain outside Phase 1 implementation and are the highest-priority next-phase/backlog requirements (F7.1–F7.3).
